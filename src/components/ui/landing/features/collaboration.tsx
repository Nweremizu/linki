...
export function Collaboration() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="relative size-full rounded-t-2xl border-x-2 border-t-2 border-purple-500 bg-white/70">
        <div className="absolute -top-px left-1/2 flex h-7 -translate-x-1/2 -translate-y-1/2 drop-shadow-[0_2px_4px_#e0c4fb]">
          <BadgeCap />
          <div className="-mx-px flex h-full items-center bg-purple-500 px-2 font-mono text-sm tracking-wide text-[#e0ff22]">
            SAML SSO
          </div>
...
function BadgeCap({ className }: { className?: string }) {
  return (
    <svg
      ...
      fill="none"
      viewBox="0 0 28 30"
      className={cn("h-full text-purple-500", className)}
    >
      <path
        fill="currentColor"
