...
import { CircleXmark } from "../ui/icons/circle-xmark";
import { Magnifier } from "../ui/icons/magnifier";
    ...
    return (
      <div className="relative">
        ...
        <input
          ...
          type="text"
          className={cn(
            "peer w-full h-9 rounded-md border border-gray-200 px-10 text-black outline-none placeholder:text-gray-400 sm:text-sm",
